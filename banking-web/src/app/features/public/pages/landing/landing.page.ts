      ...
      <div class="relative mx-auto w-full max-w-6xl px-5 py-20 sm:px-6 sm:py-24 lg:py-28">
        <div class="max-w-2xl">
          ...
          <p class="mt-5 max-w-xl text-base leading-7 text-white/75 sm:text-lg">
            Ingresá para acceder a tu cuenta desde Nerva Banking.
          </p>

          <a
            href="/web/auth/login/home"
            class="mt-8 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-white px-5 text-sm font-semibold text-brand shadow-lg transition-colors hover:bg-slate-50 sm:w-auto"
          >
            Ingresar
