    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> {
                    ...
                    authorize.requestMatchers(HttpMethod.POST, "/internal/documents").hasRole("DOCUMENT_WRITE");
                    authorize.requestMatchers(HttpMethod.GET, "/internal/documents/**").hasRole("DOCUMENT_READ");
                    authorize.requestMatchers("/internal/documents/**").denyAll();
