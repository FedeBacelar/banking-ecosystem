    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> {
                    ...
                    authorize.requestMatchers(HttpMethod.POST, "/internal/notifications/email").hasRole("NOTIFICATION_WRITE");
                    authorize.requestMatchers("/internal/notifications/**").denyAll();
